...
//		String createUserURL = "http://localhost:8800/p/create/account";
		...
		formParams.add(new BasicNameValuePair("role","1"));
		formParams.add(new BasicNameValuePair("group","2"));
		formParams.add(new BasicNameValuePair("delegatepayment", "1"));

		
		String responseContent = RestfulUtil.postFormData(createUserURL, formParams,MediaType.APPLICATION_FORM_URLENCODED_VALUE);
...
//		String createUserURL = "https://admapi.live.iparkingstg.com/p/create/account";
		...
		String responseContent = RestfulUtil.postFormData(updateUserURL, formParams,MediaType.APPLICATION_FORM_URLENCODED_VALUE);
		JSONObject jsonObject = new JSONObject(responseContent);
