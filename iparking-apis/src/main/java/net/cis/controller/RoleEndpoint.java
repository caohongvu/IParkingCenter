...
public class RoleEndpoint {
	...
	@ApiOperation("Lấy toàn bộ roles của hệ thống")
	public @ResponseBody ResponseDto filter(@RequestParam(name = "status", required = false) Integer status) {
		ResponseDto responseDto = new ResponseDto();
		try {
			if (status == null) {
				List<RoleDto> dtos = roleService.findAll();
	...
	public @ResponseBody ResponseDto create(@RequestParam(name = "desc") String desc,
	...
	public @ResponseBody ResponseDto update(@RequestParam(name = "id") Long id,
